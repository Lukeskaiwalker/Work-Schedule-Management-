...
export function activityEventLabel(eventType: string, language: Language) {
  const map: Record<string, { de: string; en: string }> = {
    ...
    "project.visit_posted": { de: "Kundenbesuch erfasst", en: "Customer visit recorded" },
    "project.visit_updated": { de: "Kundenbesuch geändert", en: "Customer visit changed" },
    "project.visit_deleted": { de: "Kundenbesuch gelöscht", en: "Customer visit deleted" },
