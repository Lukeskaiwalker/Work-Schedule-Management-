...
comes back into the workshop — that half lives in
``services/task_material_settlement.py``. Selecting a box on a task is still a
statement of intent, not a movement.
"""
