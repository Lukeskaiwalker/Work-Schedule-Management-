...
class User(Base):
    ...
    vacation_days_per_year: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    vacation_days_available: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    vacation_days_carryover: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    vacation_balance_year: Mapped[int | None] = mapped_column(Integer)
