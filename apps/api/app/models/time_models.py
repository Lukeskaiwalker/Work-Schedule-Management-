...
class VacationRequest(Base):
    ...
    deducted_available_days: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    deducted_carryover_days: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
